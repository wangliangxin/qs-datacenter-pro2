...

    {
        ...
        children: [
            ...
            // },
            {
                ...
                meta: { requireAuth: true, title: process.env.VUE_APP_NAME },
                component: () =>
                    import ( /* webpackChunkName: 'home' */ '../views/CourseManage/Courses.vue')
            },
            {
                path: '/courses',
                name: 'Courses',
                ...
                component: () =>
                    import ( /* webpackChunkName: 'courses' */ '../views/CourseManage/Courses.vue')
            },
            {
            ...
            },
            {
                ...
                name: 'CourseSections',
                meta: { requireAuth: false, title: '课时信息' },
                component: () =>
                    import ( /* webpackChunkName: 'courses' */ '../views/CourseManage/CourseSections.vue')
            },
            {
                ...
                component: () =>
                    import ( /* webpackChunkName: 'courses' */ '../views/CourseManage/VideoOptions.vue')
            },
            {
                path: '/users',
                name: 'Users',
                ...
                component: () =>
                    import ( /* webpackChunkName: 'comments' */ '../views/CommentManage/Comments.vue')
            },
            {
                ...
                component: () =>
                    import ( /* webpackChunkName: 'comments' */ '../views/CommentManage/CommentItem.vue')
            },
            {
                path: 'role',
                name: 'Role',
                component: () =>
                    import ( /* webpackChunkName: 'role' */ '../views/PermissionManage/Roles'),
            ...
            },
            {
                ...
                name: 'AllocMenu',
                component: () =>
                    import ( /* webpackChunkName: 'allocMenu' */ '../views/PermissionManage/AllocMenu'),
            ...
            },
            {
                ...
                name: 'AllocResource',
                component: () =>
                    import ( /* webpackChunkName: 'allocResource' */ '../views/PermissionManage/AllocResource'),
            ...
            },
            {
                ...
                name: 'Menu',
                component: () =>
                    import ( /* webpackChunkName: 'menu' */ '../views/PermissionManage/Menus'),
            ...
            },
            {
                ...
                name: 'AddMenu',
                component: () =>
                    import ( /* webpackChunkName: 'menuAdd' */ '../views/PermissionManage/AddMenu'),
            ...
            },
            {
                ...
                name: 'UpdateMenu',
                component: () =>
                    import ( /* webpackChunkName: 'menuUpdate' */ '../views/PermissionManage/UpdateMenu'),
            ...
            },
            {
                ...
                name: 'Resource',
                component: () =>
                    import ( /* webpackChunkName: 'resource' */ '../views/PermissionManage/Resources'),
            ...
            },
            {
                ...
                component: () =>
                    import ( /* webpackChunkName: 'categoryList' */ '../views/PermissionManage/CategoryList'),
                ...
                name: 'Advertise',
                component: () =>
                    import ('../views/AdvertiseManage/Advertises'),
            ...
            },
            {
                ...
                name: 'AddAdvertise',
                component: () =>
                    import ('../views/AdvertiseManage/AddAdvertise'),
            ...
            },
            {
                ...
                component: () =>
                    import ('../views/AdvertiseManage/UpdateAdvertise'),
                meta: { requireAuth: true, title: '编辑广告' }
            }, {
                path: 'advertiseSpace',
                name: 'AdvertiseSpace',
                component: () =>
                    import ('../views/AdvertiseManage/AdvertiseSpaces'),
                meta: { requireAuth: true, title: '广告位管理' }
            }, {
                path: 'addAdvertiseSpace',
                name: 'AddAdvertiseSpace',
                component: () =>
                    import ('../views/AdvertiseManage/AddAdvertiseSpace'),
